...
func TestPolicyCRUD(t *testing.T) {
	...
	p, err := db.CreatePolicy("Allow prod", "pattern", []string{"myorg/*"}, []string{"refs/heads/main"}, []string{"*"}, "")
	require.Nil(t, err)
	...
	err = db.UpdatePolicy(p.ID, "Updated", "pattern", []string{"other/*"}, []string{"*"}, []string{"*"}, "")
	require.Nil(t, err)
...
func TestCreatePolicyValidation(t *testing.T) {
	...
	_, err := db.CreatePolicy("", "pattern", []string{"*"}, []string{"*"}, []string{"*"}, "")
	require.NotNil(t, err)

	// Invalid glob pattern is rejected.
	_, err = db.CreatePolicy("bad", "pattern", []string{"org/["}, []string{"*"}, []string{"*"}, "")
	require.NotNil(t, err)
}
...
func TestMatchingPolicyIDs(t *testing.T) {
	...
	p1, _ := db.CreatePolicy("p1", "pattern", []string{"myorg/*"}, []string{"refs/heads/main"}, []string{"*"}, "")
	db.CreatePolicy("p2", "pattern", []string{"myorg/specific"}, []string{"*"}, []string{"*"}, "")
	db.CreatePolicy("p3", "pattern", []string{"other/*"}, []string{"*"}, []string{"*"}, "")
...
func TestMatchingPolicyIDsEmptyKindMatchesNothing(t *testing.T) {
	...
	_, err := db.CreatePolicy("only-repo", "pattern", []string{"myorg/*"}, nil, nil, "")
	require.Nil(t, err)
...
func TestCreateEmptyPolicyMatchesNothing(t *testing.T) {
	...
	p, err := db.CreatePolicy("empty", "pattern", nil, nil, nil, "")
	require.Nil(t, err)
	require.NotNil(t, p)
...
func TestMatchingPolicyIDsActorFilter(t *testing.T) {
	...
	p, _ := db.CreatePolicy("deployers-only", "pattern", []string{"myorg/*"}, []string{"*"}, []string{"deploy-*"}, "")
...
func TestMatchingPolicyIDsLiteralBracketActor(t *testing.T) {
	...
	p, _ := db.CreatePolicy("bots", "pattern", []string{"wow-look-at-my/*"}, []string{"*"}, []string{"pr-minder[bot]", "dependabot[bot]"}, "")
	...
	pw, _ := db.CreatePolicy("anyactor", "pattern", []string{"wow-look-at-my/*"}, []string{"*"}, []string{"*"}, "")
...
func TestAttachDetachAndAuthorizedSecrets(t *testing.T) {
	...
	p, _ := db.CreatePolicy("pol", "pattern", []string{"myorg/*"}, []string{"*"}, []string{"*"}, "")
...
func TestListNodePoliciesOrderedByName(t *testing.T) {
	...
	p1, _ := db.CreatePolicy("charlie", "pattern", []string{"*"}, []string{"*"}, []string{"*"}, "")
	p2, _ := db.CreatePolicy("alpha", "pattern", []string{"*"}, []string{"*"}, []string{"*"}, "")
	p3, _ := db.CreatePolicy("bravo", "pattern", []string{"*"}, []string{"*"}, []string{"*"}, "")
...
func TestPrecedenceOrdering(t *testing.T) {
	...
	a, _ := db.CreatePolicy("a", "pattern", []string{"*"}, []string{"*"}, []string{"*"}, "")
	b, _ := db.CreatePolicy("b", "pattern", []string{"*"}, []string{"*"}, []string{"*"}, "")
	c, _ := db.CreatePolicy("c", "pattern", []string{"*"}, []string{"*"}, []string{"*"}, "")
...
func TestPrecedenceSelfLoopRejected(t *testing.T) {
	db := testDB(t)
	g, _ := db.CreateGroup(nil, "g")
	p, _ := db.CreatePolicy("p", "pattern", []string{"*"}, []string{"*"}, []string{"*"}, "")
